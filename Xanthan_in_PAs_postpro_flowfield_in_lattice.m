...
time_interval = 1/15*(500/20); % time interval for sampling (s)
...
% %             f=gcf;
% %             exportgraphics(f,['Z:\Processing & Results\PIV & PTV\Figures\', ...
% %                 exp2proc(end-30:end-22), theFOLDER(end-8:end), 'flowfield_in_lattice_ave.png'],'Resolution',100)
...
% %             f=gcf;
% %             exportgraphics(f,['Z:\Processing & Results\PIV & PTV\Figures\', ...
% %                 exp2proc(end-30:end-22), theFOLDER(end-8:end), 'flowType_in_lattice_ave.png'],'Resolution',100)
        ...
        case 'No'
            ...
            viscircles([0, 0; 0, 1; 1, 0; 1, 1], r_pillar*ones(4,1)+0.005,'Color','k', 'LineWidth', 10);
            xlim([0 1]); ylim([0 1]); 
            camroll(-90)

% % %             f=gcf;
% % %             exportgraphics(f,['Z:\Processing & Results\PIV & PTV\Figures\Xanthan\', ...
% % %                 exp2proc(35:end),'_', theFOLDER(32:end), 'flowfield_in_lattice_ave.png'],'Resolution',100)

% %             f=gcf;
% %             exportgraphics(f,['Z:\Processing & Results\PIV & PTV\Figures\PEO\20240307_100nL_Z27.52\', ...
% %                 'exp_20240307_PEO4M1000ppm_100nL_Z27.52um_flowfield_in_lattice_ins_',num2str(theFOLDER_no),'.png'],'Resolution',100)
            f=gcf;
            exportgraphics(f,['Z:\Processing & Results\PIV & PTV\Figures\PEO\', ...
                exp2proc(35:end),'_', theFOLDER(33:end), 'flowfield_in_lattice_ave_alpha0o5.png'],'Resolution',100)

            set(gcf,'renderer','Painters');
            print('-depsc2','-tiff','-r100','-vector',['Z:\Processing & Results\PIV & PTV\Figures\PEO\', ...
                exp2proc(35:end),'_', theFOLDER(33:end), 'flowfield_in_lattice_ave_alpha0o5.eps']);
...
% % %             f=gcf;
% % %             exportgraphics(f,['Z:\Processing & Results\PIV & PTV\Figures\Xanthan\', ...
% % %                 exp2proc(35:end),'_', theFOLDER(32:end), 'flowType_in_lattice_ave.png'],'Resolution',100)

% %             f=gcf;
% %             exportgraphics(f,['Z:\Processing & Results\PIV & PTV\Figures\PEO\20240307_100nL_Z27.52\', ...
% %                 'exp_20240307_PEO4M1000ppm_100nL_Z27.52um_flowType_in_lattice_ins_',num2str(theFOLDER_no),'.png'],'Resolution',100)
...
% % %     %% Figures: velocity field (in field of view)
% % %     figure('color', 'w','units','normalized','outerposition',[0 0 1 1]); 
...
% % %     f=gcf;
% % %     exportgraphics(f,['Z:\Processing & Results\PIV & PTV\Figures\', ...
% % %         exp2proc(end-30:end-22), theFOLDER(end-8:end), 'flowType.png'],'Resolution',100)
% % % 
% % %     %% Figures: flowtype (in field of view)
% % %     figure('color', 'w','units','normalized','outerposition',[0 0 1 1]); 
% % %     contourf(x_phy, y_phy, v_phy_mag,100,'LineStyle','none'); hold on 
...
% % %     f=gcf;
% % %     exportgraphics(f,['Z:\Processing & Results\PIV & PTV\Figures\', ...
% % %         exp2proc(end-30:end-22), theFOLDER(end-8:end), 'flowfield.png'],'Resolution',100)
